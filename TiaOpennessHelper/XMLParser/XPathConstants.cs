namespace TiaOpennessHelper.XMLParser
{
    ...
    public static class XPathConstants
    {
        ...
        public const string Xpathblockname = "//Name";

        /// <summary>The xpathblocknumber</summary>
        /// TODO Edit XML Comment Template for XPATHBLOCKNUMBER
        public const string Xpathblocknumber = "//Number";

        /// <summary>The xpathblocktype</summary>
        /// TODO Edit XML Comment Template for XPATHBLOCKTYPE
        public const string Xpathblocktype = "//Type";

        /// <summary>The xpathblocklanguage</summary>
        /// TODO Edit XML Comment Template for XPATHBLOCKLANGUAGE
        public const string Xpathblocklanguage = "//ProgrammingLanguage";

        /// <summary>
        /// The xpathblockmemorylayout
        /// </summary>
        /// TODO Edit XML Comment Template for XPATHBLOCKMEMORYLAYOUT
        public const string Xpathblockmemorylayout = "//MemoryLayout";

        /// <summary>The xpathblockauthor</summary>
        /// TODO Edit XML Comment Template for XPATHBLOCKAUTHOR
        public const string Xpathblockauthor = "//HeaderAuthor";

        /// <summary>The xpathblocktitle</summary>
        /// TODO Edit XML Comment Template for XPATHBLOCKTITLE
        public const string Xpathblocktitle = "//ObjectList/MultilingualText[@CompositionName='Title']";

        /// <summary>The xpathblockcomment</summary>
        /// TODO Edit XML Comment Template for XPATHBLOCKCOMMENT
        public const string Xpathblockcomment = "//ObjectList/MultilingualText[@CompositionName='Comment']";

        /// <summary>The xpathblockfamily</summary>
        /// TODO Edit XML Comment Template for XPATHBLOCKFAMILY
        public const string Xpathblockfamily = "//HeaderFamily";

        /// <summary>The xpathblockversion</summary>
        /// TODO Edit XML Comment Template for XPATHBLOCKVERSION
        public const string Xpathblockversion = "//HeaderVersion";

        /// <summary>The xpathblockuserid</summary>
        /// TODO Edit XML Comment Template for XPATHBLOCKUSERID
        public const string Xpathblockuserid = "//HeaderName";

        /// <summary>The XpathblocksGlobalDB</summary>
        public const string XpathblocksGlobalDB = "//SW.Blocks.GlobalDB";

        /// <summary>The XpathblocksInstanceDB</summary>
        public const string XpathblocksInstanceDB = "//SW.Blocks.InstanceDB";

        /// <summary>The XpathblocksarrayDB</summary>
        public const string XpathblocksArrayDB = "//SW.Blocks.ArrayDB";

        /// <summary>The XpathblocksGlobalDB</summary>
        public const string XpathblocksOB = "//SW.Blocks.OB";

        /// <summary>The XpathblocksInstanceDB</summary>
        public const string XpathblocksFB = "//SW.Blocks.FB";

        /// <summary>The XpathblocksarrayDB</summary>
        public const string XpathblocksFC = "//SW.Blocks.FC";
        ...
        public const string Xpathinstanceoftype = "//InstanceOfType";
